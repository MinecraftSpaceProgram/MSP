...
public final class RenderUtils {
     ...
     */
    public static void drawReticle(MatrixStack matrixStack, IRenderTypeBuffer renderBuffers, Vector3d origin) {
    ...
    public static void square2(Minecraft mc, Tessellator tessellator, Matrix4f matrixPos, Vector3d A, Vector3d B, Vector3d C, ResourceLocation material, Color color) {
    ...
    private static void add2(BufferBuilder bufferbuilder, Matrix4f matrixPos, Vector3d A, float u, float v, Color color) {
     ...
     */
    public static void drawLogo(Minecraft minecraft, MatrixStack matrixStack, ResourceLocation texture, Vector3d position, float size, Color color){
        ...
        RenderUtils.square2(
                ...
                position.subtract(
                        new Vector3d(Y.getX() + X.getX(), Y.getY() + X.getY(), Y.getZ() + X.getZ()).scale(1.0D/2.0D)),
                texture,
                color
        );
    }

    public static void drawLogo(Minecraft minecraft, MatrixStack matrixStack, ResourceLocation texture, Vector3d position, float size){
